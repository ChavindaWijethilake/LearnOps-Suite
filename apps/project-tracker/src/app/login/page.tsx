...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-purple-100 dark:from-slate-950 dark:to-slate-900 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="bg-white/40 dark:bg-slate-900/40 backdrop-blur-md border border-white/20 rounded-2xl p-8 shadow-2xl">
          <h1 className="text-3xl font-bold text-center mb-2 text-purple-700">Project Tracker</h1>
          ...
          <div className="mt-6 p-4 bg-purple-500/10 border border-purple-500/20 rounded-lg text-sm text-gray-600 dark:text-gray-400">
