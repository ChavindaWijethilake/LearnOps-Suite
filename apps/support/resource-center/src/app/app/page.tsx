            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className={`px-3 py-1 rounded-full text-sm transition ${selectedCategory === ''
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className={`px-3 py-1 rounded-full text-sm transition ${selectedTag === ''
                    ? 'bg-amber-500/30 text-amber-700 border border-amber-400/30'
                    : 'bg-white/20 text-gray-700 dark:text-gray-300 hover:bg-white/30'
                    }`}
                >
            ...
            >
              <div className="flex items-start justify-between mb-4">
                ...
                <button
                  ...
                  className={`p-2 rounded-lg transition ${resource.bookmarked
