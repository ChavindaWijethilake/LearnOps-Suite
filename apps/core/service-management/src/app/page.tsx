      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div key={request.id} className="p-6 hover:bg-gray-50/50 transition-all group">
                  <div className="flex justify-between items-start mb-2">
                    <div className="flex items-center gap-3">
                      <span className="text-xs font-bold text-primary bg-primary/5 px-2 py-1 rounded border border-primary/10">{request.id}</span>
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="w-full bg-gray-100 rounded-full h-2">
                  <div className="bg-green-500 h-2 rounded-full w-[99.99%]" />
                </div>
              </div>
              <div>
                <div className="flex justify-between text-sm mb-2">
          ...
          <section className="bg-gray-900 rounded-2xl p-6 text-white">
            ...
            <button className="w-full py-3 bg-primary text-white rounded-xl text-sm font-bold hover:bg-primary/90 transition-all shadow-lg shadow-primary/20">
              Contact Support
            </button>
          </section>
        </div>
