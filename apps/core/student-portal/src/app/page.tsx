            ...
            >
                ...
                <div className="h-24 flex items-center px-8 gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-emerald-500 font-black uppercase tracking-[0.2em] mt-1.5 opacity-80">Portal</p>
                    </div>
                </div>
            ...
            <main className="flex-1 md:ml-[280px] min-h-screen flex flex-col relative z-10">
                ...
                >
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            <h2 className="text-xl md:text-[26px] font-bold text-white tracking-tight leading-tight">Academic Resource Hub</h2>
                        </div>
                    </div>
                                ...
                                >
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="pt-4 border-t border-white/5 flex flex-col gap-3">
                                            <Link href="http://localhost:3000/settings" className="text-left text-xs text-slate-400 hover:text-emerald-400 transition-colors">Workspace Config</Link>
                                            <Link href="http://localhost:3000/settings/performance" className="text-left text-xs text-slate-400 hover:text-emerald-400 transition-colors">API Thresholds</Link>
