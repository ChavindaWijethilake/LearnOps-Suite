...
export default function NewTaskPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/project-tracker/projects/${projectId}`);
    } catch (err) {
  ...
  return (
    <div>
      <Link href={`/project-tracker/projects/${projectId}`} className="flex items-center gap-2 text-purple-600 hover:text-purple-700 mb-8">
        ...
        <div className="bg-white/40 dark:bg-slate-900/40 backdrop-blur-md border border-white/20 rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <Link href={`/project-tracker/projects/${projectId}`}>
