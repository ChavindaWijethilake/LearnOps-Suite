...
export default function RequestDetailPage() {
  ...
  useEffect(() => {
    ...
    const fetchRequest = async () => {
      try {
        const response = await fetch(`/api/service-management/${requestId}`);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 dark:from-slate-950 dark:to-slate-900">
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Link href="/service-management" className="flex items-center gap-2 text-blue-600 hover:text-blue-700 mb-8">
