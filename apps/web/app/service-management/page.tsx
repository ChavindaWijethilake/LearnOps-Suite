  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const requestsResponse = await fetch('/api/service-management');
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <Link href="/service-management/new-request">
      ...
      <div className="bg-white/40 dark:bg-slate-800/40 backdrop-blur-md border border-white/20 rounded-xl overflow-hidden">
        ...
        {requests.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <Link href="/service-management/new-request" className="mt-4 inline-block">
              ...
              <tbody>
                {requests.map((request) => (
                  <tr key={request.id} className="border-b border-white/20 hover:bg-white/10 transition">
                    ...
                    <td className="px-6 py-4">
                      <Link href={`/service-management/request/${request.id}`}>
